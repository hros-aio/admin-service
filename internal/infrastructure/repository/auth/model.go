...
type adminUserModel struct {
	...
	SSOIdentityID       *string   `gorm:"column:sso_identity_id;type:varchar(255);uniqueIndex:idx_admin_users_sso"`
	SSOProvider         *string   `gorm:"column:sso_provider;type:varchar(255);uniqueIndex:idx_admin_users_sso"`
